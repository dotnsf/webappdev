    ...
    success: function( result ){
      ...
      result.forEach( function( data ){
        var tr = '<tr>'
          ...
          + "<td><input type='button' class='editbutton' value='編集' onClick='editData(" + JSON.stringify( data ) + ")'/>"
          + "<input type='button' class='deletebutton' value='削除' onClick='deleteData(\"" + data.country + "\")'/></td>"
          + '</tr>';
        $('#tbody1').append( tr );
      });
